#!/usr/bin/env python3
#
# Objective5 formal zero-impairment baseline: ONLY the two cooperative_avoider
# controllers (identical frozen head_on_cpa_v4 geometry/CPA parameters).
# Launched separately from, and strictly AFTER, the relay+sequence_counter
# pair (see run_objective5_comm_baseline_formal_trial.sh) so the relay's
# subscription to state_raw and the counter's subscription to both topics
# are already confirmed live before state_publisher (and therefore any
# real traffic) exists.
