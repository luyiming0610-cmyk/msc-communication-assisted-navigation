# FORMAL_SIM -- Condition A, Trial 05, attempt 01

`objective5_impairment_matrix_v1_condition_A_trial05_attempt01` -- part of a formal n=5 batch for Condition A
...
| mean bandwidth (bytes/s) | 710.1398953909352 | 710.251728663264 |
...
- `ros2 bag info` succeeded (3184 messages, 7 topics, 51.717647716s duration).
- `preload_realtime_factor=0.96`, `full_load_realtime_factor=0.982`.

## Safety

`min_interrobot_distance_m=0.14178534915907265`, `safety_radius_m=0.14`, `safety_margin_m=0.0017853491590726356`.

## Process cleanup / data integrity

- Post-run process check: **CLEAN**.
- Native WSL bag copied to `experiments/05_objective5_impairment_matrix/bags/objective5_impairment_matrix_v1_condition_A_trial05_attempt01/` (gitignored) -- SHA-256 verified identical to native WSL source (bag + diag_logs). See `SHA256SUMS`.
