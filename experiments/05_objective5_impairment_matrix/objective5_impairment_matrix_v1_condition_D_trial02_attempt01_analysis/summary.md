...
| missing/duplicate/out_of_order (LEGACY, invalid) | 197/0/91 | 180/0/83 |
| capture_ratio (LEGACY, invalid) | 1.0 | 1.0 |
...
| | epuck1&rarr;epuck2 | epuck2&rarr;epuck1 |
|---|---|---|
| relay forwarded (unique) | 430 | 419 |
| relay dropped | 0 | 0 |
| **actual_missing_count** | **0** | **0** |
| out_of_order (adjacent/displaced, forwarded) | 91/101 | 83/89 |
