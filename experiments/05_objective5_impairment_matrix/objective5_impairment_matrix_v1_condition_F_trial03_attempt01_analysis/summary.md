# Condition F Trial 03 formal result
...
- Relay outage drops: `20` (epuck1 to epuck2), `22` (epuck2 to epuck1)
- Consumer capture ratio: `0.955457`, `0.955850`; duplicates/out-of-order: `0/0` both directions
- Minimum separation: `0.146625467 m`
- Safety margin above 0.14 m: `6.625 mm`
...
- Mechanism classification: `EXPECTED_SAFE_DEGRADATION_WITH_RECOVERY`
- Local safety layer engaged: `false`. This is an observation, not a claim that outage causally triggered the local layer.
