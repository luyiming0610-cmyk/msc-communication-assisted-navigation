# Condition E Trial 03 formal result
...
- Observed drop fraction: `0.1292` (epuck1 to epuck2), `0.1103` (epuck2 to epuck1)
- Authoritative relay delivery ratio: `0.8708`, `0.8897`
- Interior sequence gaps: `54`, `48`; duplicates/out-of-order: `0/0` both directions
...
- Minimum separation: `0.149538948 m`
- Safety margin above 0.14 m: `9.539 mm`
